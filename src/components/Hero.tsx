...
export function Hero() {
  ...
  // Update handleChange to use React.ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        message: `New quote request from ${formData.firstName} ${formData.lastName}. \nEmail: ${formData.email}, \nPhone: ${formData.phone}, \nDebt Amount: ${formData.debtAmount}, \nState: ${formData.state}`,
